...
export const URL = {
  INDEX: "https://euronotify.diogocardoso.dev",
  EDIT: _.template(
    "https://euronotify.diogocardoso.dev/editnotification/${token}/${minPrize}/"
  ),
  DELETE: _.template(
    "https://euronotify.diogocardoso.dev/deletenotification/${token}"
  ),
};
